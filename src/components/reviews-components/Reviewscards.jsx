...
const ReviewCard = ({ review, scrollProgress, columnIndex }) => {
  ...
  const parallaxOffset =
    scrollProgress * (columnIndex === 0 ? 15 : columnIndex === 1 ? -10 : 20);
  ...
  return (
    ...
    >
      ...
      <div className="p-5 pt-4 flex flex-col flex-grow">
        ...
        <p
          className={`text-[#1d322d] leading-relaxed flex-grow ${
            review.size === "small"
              ? "text-sm"
              : review.size === "large"
                ? "text-base"
  ...
  const reviews = [
    {
      id: 1,
      type: "text",
      reviewer: "Mr. & Mrs. Pingle",
      location: "Restaurant Owner",
      source: "",
      stars: 5,
      text: "The furniture is exceptionally sturdy and durable, far exceeding our expectations for the price. You can truly see the difference in craftsmanship—it’s a cut above the rest. Every detail reflects quality and care, making our home both beautiful and functional. We’re extremely satisfied with the overall experience and final result.",
      size: "large",
    },
    {
      id: 2,
      type: "text",
      reviewer: "Mr. & Mrs. Gawhane",
      location: "Home Owner",
      source: "",
      stars: 5,
      text: "We needed furniture that perfectly fit our compact apartment space, and the team absolutely nailed it. The design is stylish, space-efficient, and thoughtfully planned for everyday comfort. The smart storage solutions have truly improved our home’s functionality and workflow.",
      size: "medium",
    },
    {
      id: 3,
      type: "text",
      reviewer: "Mr. & Mrs. Munde",
      location: "Home Owner",
      source: "",
      stars: 5,
      text: "Working with the company was a seamless experience from start to finish. The team was professional, responsive, and patient throughout the design process. Installation was hassle-free and completed right on time.",
      size: "small",
    },
    {
      id: 4,
      type: "image",
      image:
        "https://framerusercontent.com/images/RmuI2pxfTjlOuiW99H1cZ6zZY08.jpg",
      reviewer: "Mr. & Mrs. Polkam",
      location: "Shop Owner",
      source: "",
      stars: 5,
      text: "Great experience overall! The team offered cost-efficient solutions with honest pricing—without compromising on quality. Excellent value for money and complete satisfaction.",
      size: "medium",
    },
    {
      id: 5,
      ...
      image:
        "https://framerusercontent.com/images/RmuI2pxfTjlOuiW99H1cZ6zZY08.jpg",
      reviewer: "Mr. Sumit Suradkar",
      location: "Shop Owner",
      source: "",
      stars: 5,
      text: "Absolutely the best service and quality! The team delivered beyond expectations with excellent attention to detail. A perfect blend of professionalism and craftsmanship.",
      size: "large",
    },
    {
      id: 6,
      ...
      image:
        "https://framerusercontent.com/images/RmuI2pxfTjlOuiW99H1cZ6zZY08.jpg",
      reviewer: "Mr. Pranit Wadatkar",
      location: "Shop Owner",
      source: "",
      stars: 5,
      text: "The work quality is truly first-rate, and the service exceeded my expectations. Every detail was handled with care and professionalism. Thank you, Prime Kitchen Studio!",
      size: "medium",
    },
    {
      id: 7,
      ...
      image:
        "https://framerusercontent.com/images/RmuI2pxfTjlOuiW99H1cZ6zZY08.jpg",
      reviewer: "Mr. Ganesh Karhade",
      location: "Shop Owner",
      source: "",
      stars: 5,
      text: "Exceptional work and a seamless experience throughout the project. Top-notch quality, impressive attention to detail, and true professionalism.",
      size: "small",
    },
    {
      id: 8,
      ...
      image:
        "https://framerusercontent.com/images/RmuI2pxfTjlOuiW99H1cZ6zZY08.jpg",
      reviewer: "Ms. Sonali Gudadhe Chavan",
      location: "Shop Owner",
      source: "",
      stars: 5,
      text: "Fantastic experience with Prime Kitchen Studio! The team understood my needs and turned my ideas into a beautiful reality. Outstanding quality and finishing.",
      size: "large",
    },
    {
      id: 9,
      ...
      image:
        "https://framerusercontent.com/images/RmuI2pxfTjlOuiW99H1cZ6zZY08.jpg",
      reviewer: "Mr. Soham Chavan",
      location: "Shop Owner",
      source: "",
      stars: 5,
      text: "Prime Kitchen Studio did an amazing job from concept to completion. Modern, practical designs with exceptional quality and flawless execution.",
      size: "medium",
    },
    {
      id: 10,
      ...
      image:
        "https://framerusercontent.com/images/RmuI2pxfTjlOuiW99H1cZ6zZY08.jpg",
      reviewer: "Mr. Achut Moharir",
      location: "Shop Owner",
      source: "",
      stars: 5,
      text: "Outstanding experience with Prime Kitchen Studio! Exceptional craftsmanship, thoughtful design, and professional execution. Highly satisfied with the result.",
      size: "large",
    },
    {
      id: 11,
      ...
      image:
        "https://framerusercontent.com/images/RmuI2pxfTjlOuiW99H1cZ6zZY08.jpg",
      reviewer: "Mr. Hrishikesh Sangit",
      location: "Shop Owner",
      source: "",
      stars: 5,
      text: "Excellent work by Prime Kitchen Studio! Professional, punctual, and detail-oriented. The final outcome exceeded my expectations.",
      size: "medium",
    },
  ];
