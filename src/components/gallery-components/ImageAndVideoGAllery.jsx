...
const mediaItems = [
  {
    ...
    image: `${process.env.NEXT_PUBLIC_CLOUDFRONT_URL}/gallery-page-images/1.png`,
    type: "photo",
  },
  {
    id: "2",
    title: "Bathroom Bliss",
    image: `${process.env.NEXT_PUBLIC_CLOUDFRONT_URL}/gallery-page-images/2.png`,
    type: "photo",
  },
  {
    id: "3",
    title: "Living Room Stories",
    image: `${process.env.NEXT_PUBLIC_CLOUDFRONT_URL}/gallery-page-images/3.png`,
    type: "photo",
  },
  {
    id: "4",
    title: "Serene Bedrooms",
    image: `${process.env.NEXT_PUBLIC_CLOUDFRONT_URL}/gallery-page-images/8.png`,
    type: "photo",
  },
  {
    id: "5",
  ...
  },
  {
    id: "6",
    title: "Serene Bedrooms",
    image: `${process.env.NEXT_PUBLIC_CLOUDFRONT_URL}/gallery-page-images/10.png`,
    type: "photo",
  },
  {
    id: "7",
    title: "Bathroom Bliss",
    image: `${process.env.NEXT_PUBLIC_CLOUDFRONT_URL}/gallery-page-images/11.png`,
    type: "photo",
  },
  {
    id: "8",
    title: "Living Room Stories",
    image: `${process.env.NEXT_PUBLIC_CLOUDFRONT_URL}/gallery-page-images/12.png`,
    type: "photo",
  },
  // {
  //   id: "9",
  //   title: "Serene Bedrooms",
  //   image: `${process.env.NEXT_PUBLIC_CLOUDFRONT_URL}/gallery-page-images/13.png`,
  //   type: "photo",
  // },
  // {
  //   id: "10",
  //   title: "Luxury Kitchens",
  //   image: `${process.env.NEXT_PUBLIC_CLOUDFRONT_URL}/gallery-page-images/14.png`,
  //   type: "photo",
  // },
  {
    id: "11",
                      ...
                      <>
                        <div className="relative w-full h-full">
                          ...
                          <img
                            src={item.image || "/placeholder.svg"}
                            alt={item.title}
                            className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105 rounded-lg"
                          />
                        </div>
