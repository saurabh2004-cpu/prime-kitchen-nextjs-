...
const ClientsSection = () => {
    ...
    return (
        <motion.div 
            className="w-full  md:my-32 md:py-4 px-4 pb-24  max-w-[90em] mx-auto rounded-3xl mt-20 md:mt-20" 
        ...
        >
            <div className=" mx-auto">
                ...
                <motion.div 
                    ...
                    viewport={{ once: true, amount: 0.3 }}
                >
                    <div className="flex items-center justify-center text-sm  relative md:top-2 ">
                        <svg className="w-5 h-5 text-[#009f93] " viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <circle cx="12" cy="12" r="6" strokeWidth="2" />
                            <circle cx="12" cy="12" r="3.2" fill="currentColor" />
                        </svg>
                        <span className="text-xsm md:text-[12px] md:font-semibold text-[#009f93] uppercase tracking-wider inter-placeholder tracking-[-0.2em]">
                            Clients
                        </span>
                    </div>
                    <h2 className="text-4xl sm:text-5xl md:text-[48px] md:font-bold tracking-tight leading-tight font-extrabold  leading-tight inter-placeholder text-[#1D322D]" style={{ color: "#009f93", fontWeight: 1000,  }}>
                        Associated Brands
                    </h2>
                </motion.div>
                    ...
                    <div className="flex mt-4">
                        ...
                        >
                            {duplicatedClients.map((client, index) => (
                                <div
                                    key={index}
                                    className="flex-shrink-0 h-full max-w-[400px] min-w-[250px] min-h-[60px] items-center flex-row gap-4 gap-x-6 align-center justify-center bg-[#0000000D] min-w-[200px] rounded-2xl p-4  mx-2  flex flex-col relative overflow-hidden"
                                >
