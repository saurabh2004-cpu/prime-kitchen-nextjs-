          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-4">
              ...
              >
                ...
                >
                  <div className="flex justify-between items-center">
                    <span className=" text-sm font-medium inter-placeholder md:text[12px] md:font-semibold text-[#fdfcee] ">
                      EMAIL
                    </span>
                    <a
                      href="mailto:Prime@email.com"
                      className="text-[#f8f8f5] text-[16px] pl-4 md:pl-0  md:text[16px] md:font-medium  text-[#fdfcee] hover:underline text-[#fdfcee] inter-placeholder  "
                    >
                ...
                >
                  <div className="flex justify-between items-center ' inter-placeholder ">
                    <span className="text-sm font-medium inter-placeholder md:text[12px] md:font-semibold text-[#fdfcee] uppercase">
                      Branch-1
                    </span>
                    <a
            ...
            >
              ...
              <motion.p
                ...
                viewport={{ once: true, amount: 0.3 }}
              >
                Reach out to us immediately to arrange for a customized
                quotation from one of our assessors. Phone us or complete the
                form provided below!
              </motion.p>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 inter-placeholder ">
                  {/* Name */}
                  <div>
                    <label className="block text-[12px] md:text[12px] md:font-bold inter-placeholder font-semibold text-[#1d322d] mb-2 ">
                      NAME
                    </label>
                    <input
                      type="text"
                ...
                <button
                  ...
                  className={`w-full bg-[#165a65] text-[#fffef2] font-medium py-3 px-6 rounded-lg inter-placeholder transition-colors ${
                    sending
      ...
      >
        <div className="flex flex-col lg:flex-row mb-8">
          ...
          >
            ...
            {/* <motion.div
              className="grid grid-cols-3 gap-3 px-4 md:px-20 md:w-190 "
              variants={staggerContainer}
              initial="hidden"
              whileInView="visible"
            ...
            > */}
            <motion.div
              className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 px-4 sm:px-8 md:px-20 max-w-5xl mx-auto"
              variants={staggerContainer}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.2 }}
            >
              ...
              <SocialCard
                icon={
                  <Facebook className="w-8 h-8 bg-white rounded-full text-black" />
                }
                name="FACEBOOK"
              ...
              {/* <SocialCard
                  icon={
                    <IconBrandLinkedinFilled className="w-8 h-8  text-white" />
                  }
                  name="LINKEDIN"
                  href="https://linkedin.com"
                /> */}
            ...
            {/* <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              <h3 className="text-sm font-semibold  mb-4 md:text[20px] md:font-medium tracking-wider inter-placeholder text-[#fdfcee]">
          ...
          {/* <motion.div
            className="w-full xl:w-1/2 border"
            variants={slideInRight}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }}
          >
            <div className="flex flex-col md:flex-row items-center md:mt-20 xl:mt-0 border">
              ...
              <motion.div
                ...
                viewport={{ once: true, amount: 0.3 }}
              >
                <h3 className="text-lg font-medium md:text[18px] md:font-medium uppercase px-4 mb-4 py-8 md:text-center pb-2 text-[#009f93] inter-placeholder ">
                  Menu
                </h3>
                <div className="flex flex-col gap-3 text-sm px-4 md:items-center ">
                  {[
                    ...
                    <motion.a
                      ...
                      className={`flex w-1/8 text-start md:text[16px] md:font-medium md:w-1/6 hover:opacity-80 transition-opacity text-[16px] font-medium inter-placeholder hover:text-[#009f93]  animate-underline duration-900 ease-in-out text-[#fdfcee] text-start ${
                        index === 0 ? "text-[#fdfcee] " : ""
                      }`}
              ...
              <motion.div
                ...
                viewport={{ once: true, amount: 0.3 }}
              >
                <h3 className="text-lg font-medium uppercase mb-4 md:text[18px] md:font-medium tracking-wider mt-8 md:mt-0  px-4  pb-2 text-[#009f93]">
                  Services
                </h3>
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            <div className="flex flex-col md:flex-row items-start gap-10 md:gap-0 mt-10 md:mt-20 xl:mt-0">
              {/* Menu Column */}
              <motion.div
                className="w-full md:w-1/2 items-start px-4 sm:px-16 md:px-32"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, ease: "easeOut", delay: 0.2 }}
                viewport={{ once: true }}
              >
                <h3 className="px-4 mb-4 text-lg font-medium uppercase text-[#009f93] inter-placeholder">
                  Menu
                </h3>
                ...
                <div className="flex flex-col gap-3 px-4">
                  {[
                    ...
                    <motion.a
                      ...
                      href={`/${item.toLowerCase()}`}
                      className="
                text-[16px] font-medium inter-placeholder
                text-[#fdfcee]
                hover:text-[#009f93]
                transition-colors
                animate-underline
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="px-4 mb-4 text-lg font-medium uppercase tracking-wider text-[#009f93] text-center md:text-left">
                  Services
                </h3>
        ...
        >
          <div className="inter-placeholder font-black text-[#009f93] leading-[0.8] tracking-tight mb-8 relative">
            <div className="text-[clamp(130px,30vw,400px)] xl:text-[clamp(200px,40vw,500px)] relative z-10 tracking-[-0.05em]">
              Prime
            </div>
        ...
        >
          ...
          {/* Footer Content */}
          <div className="flex flex-col md:flex-row justify-center items-start md:items-center gap-6 py-6 px-4 sm:px-6 md:px-8">
            {/* Links Section */}
            {/* <div className="w-full md:w-auto flex justify-center md:justify-start px-16">
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 text-center md:text-left">
                <a
                  href="/privacy"
                  className="text-sm sm:text-md md:text[1rem] md:font-medium text-[#fdfcee] hover:underline inter-placeholder"
                >
                  Privacy Policy
                </a>
                <a
                  href="/terms"
                  className="text-sm sm:text-md hover:underline md:text[1rem] md:font-medium text-[#fdfcee] inter-placeholder"
                >
                  Terms
                </a>
              </div>
...
//         {icon}
//       </div>
//       <span className="text-sm uppercase md:text[12px] md:font-normal tracking-wider inter-placeholder  text-[#eeeee1]">
//         {name}
//       </span>
//     </motion.a>
//   );
...
const SocialCard = ({ icon, name, href }) => {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
    >
      <div className="mb-2 text-white transition-transform group-hover:scale-110">
        {icon}
      </div>

      <span className="text-xs sm:text-sm uppercase tracking-widest text-[#eeeee1] inter-placeholder">
        {name}
      </span>
    </motion.a>
  );
