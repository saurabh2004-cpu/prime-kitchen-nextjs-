  ...
  return (
    <section className="bg-[#F7F6E9] pt-8 relative md:bottom-24">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-24">
        ...
        <motion.div
          className="flex justify-center w-full bg-white/50 bg-blur-lg items-center align-center item-center w-full h-full mt-[-20px] backdrop-filter backdrop-blur-sm rounded-2xl"
