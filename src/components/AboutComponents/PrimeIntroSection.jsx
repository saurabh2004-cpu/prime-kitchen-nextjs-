...
import {
  ...
  UserCog,
  UserIcon,
  LockIcon as UserLockIcon,
  Trophy,
  RotateCwIcon as RotateCwSquareIcon,
} from "lucide-react";
  ...
  return (
    <section className="w-full md:px-4 lg:px-6 xl:px-8 2xl:px-12 py-8 md:pt-24 bg-[#1f3630] min-h-screen rounded-t-2xl md:rounded-t-2xl">
      ...
      >
        ...
        <span className="text-xs font-medium text-[#f3ac85] tracking-tight uppercase">
          ABOUT US
        </span>
      </motion.div>
      ...
      <div
        ref={ref}
        className="min-w-[100vw] w-full px-4 md:px-4 lg:px-6  py-4 md:py-4"
      >
          ...
          >
            <motion.div variants={itemVariants} className="space-y-6 min-w-9xl">
              <p className="text-3xl md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-3xl md:font-semibold leading-tight tracking-tighter text-[#fdfcee] inter-placeholder md:pr-8 ">
                Founded in 2011 in Sambhajinagar, Maharashtra, Prime Kitchen
                Studio was built on the belief that exceptional design should be
                accessible, long-lasting, and uniquely personal. As a leading
                modular furniture expert, we have devoted over 14 years to
                mastering the perfect blend of contemporary style and practical
                functionality.
              </p>
        ...
        <div className="max-w-full mx-auto">
          ...
          <div className="block md:hidden space-y-4">
            ...
            >
              ...
              <div className="relative bg-gradient-to-t from-black/70 to-transparent p-6 text-white">
                <p className="text-sm mb-4 inter-placeholder">
                  "In design, we find the delicate balance between function and
                  beauty, where every space whispers the stories of those who
                  dwell within. At Prime, our passion lies in crafting these
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <p className="text-7xl font-bold text-[#1d322d] text-start inter-placeholder">
                  2000+
                </p>
                <p className="text-lg font-medium text-[#1d322d] text-start inter-placeholder">
                  Happy Clients
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-lg font-medium text-[#1d322d] text-start inter-placeholder mt-4">
                  Projects
                </p>
                <p className="text-[#1d322d] text-[13px] mb-4 flex items-end h-full inter-placeholder">
            ...
            >
              ...
              <p className="mt-2 text-white text-lg text-[#1d322d]/75 text-center inter-placeholder">
                8 Creative Masterminds
              </p>
            </motion.div>
            ...
            >
              <p className="text-7xl font-bold inter-placeholder text-[#fffef2] text-start border-b">
                14+
              </p>
              <p
                className="text-lg font-bold text-[#fffef2] text-start inter-placeholder mt-6"
                style={{ fontWeight: 900 }}
              >
                Prestigious Experience
              </p>
              <p className="mt-2 text-[#fffef2]/85 text-[14px] mb-4 flex items-end h-1/5 inter-placeholder relative">
                Over 8 Awards won showcasing our extensive experience and
                portfolio.
              </p>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-12 gap-3  auto-rows-fr md:auto-rows-auto">
              ...
              >
                ...
                <div className="relative bg-gradient-to-t from-black/70 to-transparent p-4 lg:p-6 text-white">
                  <p className="text-sm lg:text-base xl:text-lg mb-4 inter-placeholder">
                    "In design, we find the delicate balance between function
                    and beauty, where every space whispers the stories of those
                    who dwell within. At Prime, our passion lies in crafting
                    these narratives with elegance and purpose."
                  </p>
                  <div className="flex items-center gap-3">
                    <img
              ...
              >
                ...
                {!isPlaying && (
                  <div
                    onClick={handlePlay}
                    className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-white cursor-pointer transition-opacity"
                  >
                    <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-full bg-white/80 flex items-center justify-center text-black">
                      <PlayCircleIcon className="w-6 h-6 lg:w-8 lg:h-8" />
                    </div>

                    <p className="mt-2 text-sm lg:text-base xl:text-lg text-center inter-placeholder font-medium">
                      Learn more
                      <br />
                      About Prime Design Studio
                    </p>
              ...
              >
                <p className="text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-[#1d322d] inter-placeholder">
                  2000+
                </p>
                <p className="text-sm lg:text-base text-[#1d322d] inter-placeholder mt-2">
                  Happy Clients
                </p>
              </motion.div>
              ...
              >
                <p className="text-4xl lg:text-5xl xl:text-6xl font-bold text-[#1d322d] inter-placeholder">
                  3000+
                </p>
                <div>
                  <p className="text-sm lg:text-base font-bold text-[#1d322d] inter-placeholder">
                    Projects
                  </p>
                  <p className="text-xs lg:text-sm text-[#1d322d] inter-placeholder mt-1">
                    Over 3000 successful projects completed
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="mt-3 text-white inter-placeholder text-sm lg:text-base font-medium">
                  8 Creative Masterminds
                </p>
              </motion.div>
              ...
              >
                <p className="text-4xl lg:text-5xl xl:text-6xl font-bold inter-placeholder text-[#fffef2] border-b border-[#fffef2] pb-2">
                  14+
                </p>
                <div>
                  <p className="text-sm lg:text-base font-bold text-[#fffef2] inter-placeholder">
                    Experience
                  </p>
            ...
            <div className="flex rounded-lg p-1 backdrop-blur-sm border-t border-r border-l border-[#fffef2]">
              {["Mission", "Vision"].map((tab) => (
                <button
                  ...
                  className={`px-4 sm:px-6 lg:px-8 py-2 lg:py-3 rounded-md font-medium transition-all duration-300 text-sm sm:text-base lg:text-lg ${
                    activeTab === tab
          ...
          <motion.div className="text-center mb-16" variants={itemVariants}>
            <div className="relative inline-block">
              <div className="relative md:top-8 lg:top-12 xl:top-22 left-10 md:left-20 lg:left-40 xl:left-60 2xl:left-80 flex items-center gap-1">
                <svg
                  className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-[#009F93]"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                >
                ...
                <span className="text-xs lg:text-sm md:font-semibold text-[#009F93] tracking-wider inter-placeholder font-bold">
                  OUR HISTORY
                </span>
              </div>
              {/* Main Heading */}
