            ...
            <div className="max-w-8xl mx-auto">
                ...
                <div className="hidden xl:block space-y-16 md:relative md:left-20">
                    {steps.map((step, index) => (
                        <motion.div
                            key={index}
                            className={`flex align-middle items-center ${index % 2 === 0 ? 'justify-start' : 'justify-center'}`}
                            ...
                            >
                                <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
                                    ...
                                    <div className="flex-1 text-center lg:text-left flex w-full flex-col h-full">
                                        <h3 className="text-2xl lg:text-3xl text-[#1d322d] inter-placeholder font-[900] text-[#1D322D] p-4 leading-tight mb-6">{step.title}</h3>
